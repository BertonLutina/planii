...
async function updateUser(id, data) {
    ...
    await (0, pool_1.q)('UPDATE users SET first_name=$1, last_name=$2, name=$3, job=$4, task_types=$5, role_library=$6 WHERE id=$7', [data.first_name ?? null, data.last_name ?? null, data.name, data.job ?? null, data.task_types, data.role_library, id]);
}
