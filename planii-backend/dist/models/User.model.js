...
async function createUser(data) {
    await (0, pool_1.q)('INSERT INTO users (id,name,email,pass_hash,job,first_name,last_name,avatar_url) VALUES ($1,$2,$3,$4,$5,$6,$7,$8)', [
...
async function updateUser(id, data) {
    ...
    if ('email_notifs' in data && data.email_notifs !== undefined) {
        await (0, pool_1.q)('UPDATE users SET email_notifs=$1::jsonb WHERE id=$2', [data.email_notifs, id]);
        return;
    }
...
const projectManagers = (projectId) => (0, pool_1.many)(`SELECT DISTINCT u.id, u.name, u.email, u.lang, u.email_notifs, m.role
